...
if(this.sortable&&this.sortable.indexOf(s)>=0){var p=this.subId("sort_"+s)
...
if(u?1==u?(e.sortBy[s]=-1,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-sort-desc"></i>')):-1==u&&(e.sortBy[s]=0,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-unsorted"></i>')):(e.sortBy[s]=1,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-sort-asc"></i>')),e.handlers._sort)for(var l=0,h=e.handlers._sort;l<h.length;l++){var c=h[l]
c(e.createEvent("_sort",e.sortBy))}}}})}(i)}},r.prototype.componentDidUpdate=function(t,e){this.buildBody()},r.prototype.getType=function(t){return this.types?this.types.length<=t?"":this.types[t]:""},r.prototype.buildBody=function(){var e=document.getElementById(this.id+"-b")
