...
t+="</div>"}}return this.buildRoot(this.rootTag,t)},n.prototype.componentDidMount=function(){for(var t=0;t<this.cint.length;t++){var e=this.cint[t]
...
var e=t.indexOf("^")
return e<0?'class="'+t+'"':'class="'+t.substring(0,e)+'" style="'+t.substring(e+1)+'"'},n.prototype.getElement=function(t,e){if(void 0===e&&(e=-1e3),!this.grid||!this.grid.length)return null
if(t<0&&(t=this.grid.length+t)<0&&(t=0),this.grid.length<=t)return null
if(-1e3==e)return document.getElementById(this.subId(t+"_"))
var r=this.grid[t]
return r&&r.length?(e<0&&(e=r.length-e)<0&&(e=0),r.length<=e?null:document.getElementById(this.subId(t+"_"+e))):null},n}(t.WComponent)
t.WContainer=r
var n=function(e){function r(t,r,n,i,o,s,a,u){var l=e.call(this,t||"*","WLink",n,i,o,s)||this
...
t.WCheck=u
var l=function(e){function r(t,r,n,i,o,s){var a=e.call(this,t||"*","WSelect",null,i,o,s)||this
...
t.WSelect=l
var h=function(e){function r(t,r,n,i,o,s,a){var u=e.call(this,t||"*","WTable",a,i,o,s)||this
...
return this.currRow.push({id:i,label:r,component:s,readonly:n}),this},n.prototype.addNoteField=function(e,r,n,i){n||(n=3)
var o=this.subId(e),a=new s(o,n,t.CSS.FORM_CTRL)
return this.currRow.push({id:o,label:r,component:a,readonly:i}),this},n.prototype.addDateField=function(e,r,n){var i=this.subId(e),s=new o(i,"date",0,t.CSS.FORM_CTRL)
return this.currRow.push({id:i,label:r,component:s,readonly:n}),this},n.prototype.addOptionsField=function(e,r,n,i,o){var s=this.subId(e),a=new l(s,n,!1,t.CSS.FORM_CTRL,"",i)
return this.currRow.push({id:s,label:r,component:a,readonly:o}),this},n.prototype.addBooleanField=function(e,r){var n=this.subId(e),i=new u(n,"")
return i.classStyle=t.CSS.FORM_CTRL,this.currRow.push({id:n,label:r,component:i}),this},n.prototype.addBlankField=function(t,e,n){var i=new r("",e,n)
return this.currRow.push({id:"",label:t,component:i,classStyle:e,style:n}),this},n.prototype.addInternalField=function(t,e){return void 0===e&&(e=null),this.currRow.push({id:this.subId(t),value:e}),this},n.prototype.addComponent=function(t,e,r){return r?(t?(r.id=this.subId(t),this.currRow.push({id:this.subId(t),label:e,component:r})):(r.id="",this.currRow.push({id:"",label:e,component:r})),this):this},n.prototype.componentDidMount=function(){this.main=new r(this.id+"-c")
...
l.component&&(s+=l.span&&l.span>0?l.span:1)}for(var h=!!t.CSS.FORM_GROUP,a=0;a<o.length;a++){var l=o[a]
if(l.component){var c=Math.floor(12/s)
if(c<1&&(c=1),1==c&&s<11&&(0==a||a==s-1)&&(c=2),l.span&&l.span>0&&(c*=l.span),this.main.addCol(""+c),l.component.setState(l.value),l.component instanceof u){if(!this.checkboxStyle){var f=getComputedStyle(this.context).getPropertyValue("font-size"),p=Math.round(.8*parseInt(f));(isNaN(p)||p<18)&&(p=18),this.checkboxStyle="height:"+p+"px;"}l.component.style=this.checkboxStyle}if(l.label&&!l.labelComp){var d=new i(l.id+"-l",l.label,"",l.classStyle)
l.labelComp=d.for(l.id)}h?this.main.addGroup({classStyle:t.CSS.FORM_GROUP},l.labelComp,l.component):(this.main.add(l.labelComp),this.main.add(l.component))}}}this.main.mount(this.root)},n.prototype.componentWillUnmount=function(){this.main||this.main.unmount()},n.prototype.clear=function(){this.debug&&console.log("WUX.WFormPanel.clear")
for(var t=0;t<this.rows.length;t++)for(var e=this.rows[t],r=0;r<e.length;r++){var n=e[r]
n.component&&n.component.setState(null),n.value=null}return this},n.prototype.setValue=function(t,e,r){void 0===r&&(r=!0)
var n=this.getField(t)
return n?(n.component&&n.component.setState(e),n.value=e,r&&(this.state||(this.state={}),this.state[t]=e),this):this},n.prototype.getValue=function(t){var e="string"==typeof t?this.getField(t):t
...
t[this.ripId(i.id)]=i.component?i.component.getState():i.value}return t},n.prototype.getState=function(){return this.state=this.getValues(),this.state},n.prototype.updateState=function(r){e.prototype.updateState.call(this,r),!r||t.WUtil.isEmpty(r)?this.clear():this.updateView()},n.prototype.updateView=function(){if(this.debug&&console.log("WUX.WFormPanel.updateView()"),!this.state)return void this.clear()
