...
t.WComponent=T,t.getId=e,t.firstSub=r,t.lastSub=n,t.getComponent=i,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=u,t.getState=l,t.newInstance=h,t.same=p,t.divide=c,t.str=f,t.getTagName=d,t.style=g,t.addStyle=m,t.css=y,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=S,t.toggleClass=_,t.addClassOf=D,t.removeClassOf=O,t.toggleClassOf=M,t.setCss=I,t.buildIcon=W,t.build=C
...
return n?t.formatDay(o.getDay(),i)+", "+u+"/"+a+"/"+o.getFullYear()+" "+l+":"+h+":"+p:u+"/"+a+"/"+o.getFullYear()+" "+l+":"+h+":"+p}return n?t.formatDay(o.getDay(),i)+", "+u+"/"+a+"/"+o.getFullYear()+" "+l+":"+h:u+"/"+a+"/"+o.getFullYear()+" "+l+":"+h}function i(t,e){if(void 0===e&&(e=!1),null==t)return""
...
return i(parseInt(t.replace(":","").replace(".","")))}if(t instanceof Date){var l=t.getHours()<10?"0"+t.getHours():""+t.getHours(),h=t.getMinutes()<10?"0"+t.getMinutes():""+t.getMinutes()
if(e){var a=t.getSeconds()<10?"0"+t.getSeconds():""+t.getSeconds()
return l+":"+h+":"+a}return l+":"+h}return""}function o(e,r,n,i){if(""===e||null==e)return""
...
s=h+l}return null!=r&&0!=o?null!=i&&o<0?i.replace("$",s):r.replace("$",s):null!=n&&0==o?n.replace("$",s):s}function l(t){return null==t?"":t?"S":"N"}function h(e){if(null==e)return""
...
case 12:return e?"Dicembre"+r:"Dic"+r}return""}var f={},d={}
t.global={locale:"it",init:function(e){t.debug&&console.log("[WUX] global.init..."),t.debug&&console.log("[WUX] global.init completed"),e&&e()},setData:function(t,e,r){if(void 0===r&&(r=!1),t||(t="global"),f[t]=e,!r&&d[t])for(var n=0,i=d[t];n<i.length;n++){var o=i[n]
o(e)}},getData:function(t,e){t||(t="global")
var r=f[t]
return null==r?e:r},onDataChanged:function(t,e){t||(t="global"),d[t]||(d[t]=[]),d[t].push(e)}}
var g=function(){function t(){}return t.FORM="padding-top:16px;",t.FORM_GROUP="form-group",t.FORM_CTRL="form-control",t}()
t.CSS=g,t.formatDate=e,t.isoDate=r,t.formatDateTime=n,t.formatTime=i,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=u,t.formatBoolean=l,t.format=h,t.formatDay=p,t.formatMonth=c}(WUX||(WUX={}))
var WUX
...
if(u?1==u?(e.sortBy[s]=-1,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-sort-desc"></i>')):-1==u&&(e.sortBy[s]=0,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-unsorted"></i>')):(e.sortBy[s]=1,a&&(n.innerHTML=a+' &nbsp;<i class="fa fa-sort-asc"></i>')),e.handlers._sort)for(var l=0,h=e.handlers._sort;l<h.length;l++){var p=h[l]
...
return this.currRow.push({id:i,label:r,component:s,readonly:n,type:"email"}),this},n.prototype.addOptionsField=function(e,r,n,i,o){var s=this.subId(e),a=new l(s,n,!1,t.CSS.FORM_CTRL,"",i)
...
if(p<1&&(p=1),1==p&&s<11&&(0==a||a==s-1)&&(p=2),l.span&&l.span>0&&(p*=l.span),this.main.addCol(""+p),l.component.setState(l.value),l.component instanceof u){if(!this.checkboxStyle){var c=getComputedStyle(this.context).getPropertyValue("font-size"),f=Math.round(.8*parseInt(c));(isNaN(f)||f<18)&&(f=18),this.checkboxStyle="height:"+f+"px;"}l.component.style=this.checkboxStyle}if(l.label&&!l.labelComp){var d=new i(l.id+"-l",l.label,"",l.classStyle)
...
else{var p=1e4*n+100*(r+1)+u+"",c=p==this.td?this.st:"",f=this.mt[p]
f=f?' title="'+f+'"':"",p==this.ls?t+='<td id="'+this.subId(p)+'" style="'+this.ss+c+'"'+f+">"+u+"</td>":this.am.indexOf(p)>=0?t+='<td id="'+this.subId(p)+'" style="'+this.sk+c+'"'+f+">"+u+"</td>":t+='<td id="'+this.subId(p)+'" style="'+this.sd+c+'"'+f+">"+u+"</td>",u++}if(t+="</tr>",u>a)break}return t},r.prototype.componentDidMount=function(){var e=this
