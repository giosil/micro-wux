...
!function(t){function e(t){if(t)return t instanceof HTMLElement?t.id:t instanceof T?t.id:"string"==typeof t&&t.indexOf("<")<0?0==t.indexOf("#")?t.substring(1):t:"object"!=typeof t||t.id?"":""+t.id}function i(t,i){var n=e(t)
if(!n)return""
var r=n.indexOf("-")
...
var n=e(t),r=e(i)
return n&&r&&n==r}function p(t){if(!t)return["","",""]
if(" "==t)return["","&nbsp;",""]
var e=" "==t.charAt(0)?"&nbsp;":"",i=t.length>1&&" "==t.charAt(t.length-1)?"&nbsp;":"",n=t.trim().split("<>")
return!n||n.length<2?[e,t.trim(),i]:(e+=n[0],2==n.length?[e,n[1],""]:(i+=n[2],[e,n[1],i]))}function c(t){if(t instanceof T){var e=t.name,i=t.id
...
if(e instanceof T){var i=e.rootTag
...
return i&&(r+=' class="'+i+'"'),n&&(r+=' style="'+n+'"'),r}function w(t,e){if(!t)return e
if(!e)return t
for(var i=t.split(" "),n=0,r=i;n<r.length;n++){if(r[n]==e)return t}return t+" "+e}function _(t,e){if(!t||!e)return t
...
h!=e?r+=h+" ":n=!0}return n?r.trim():r.trim()+" "+e}function W(t,e){t&&t.setAttribute("class",w(t.getAttribute("class"),e))}function S(t,e){t&&t.setAttribute("class",_(t.getAttribute("class"),e))}function C(t,e){t&&t.setAttribute("class",O(t.getAttribute("class"),e))}function U(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i]
...
r&&W(t,r),n&&t.setAttribute("style",g(n))}return t}function k(e,i,n,r,o,s){e||(e="div")
var h,l
...
if(t)return t}return this.context}return this.root},e.prototype.getState=function(){return this.state},e.prototype.setState=function(t,e,i){return this.debug&&console.log("["+c(this)+"] setState",t),this.update(this.props,t,!1,!0,this.forceOnChange||e,i),this},e.prototype.getProps=function(){return this.props},e.prototype.setProps=function(t,e,i){return this.debug&&console.log("["+c(this)+"] setProps",t),this.update(t,this.state,!0,!1,this.forceOnChange||e,i),this},e.prototype.on=function(t,e){if(!t)return this
...
if(this.debug&&console.log("["+c(this)+"] trigger",t,i),t){var r=i&&i.length>0?i[0]:void 0
if("_"==t.charAt(0)||"mount"==t||"unmount"==t||"statechange"==t||"propschange"==t){if(void 0!==r&&("statechange"==t?this.state!=i[0]&&(this.state=i[0],this.debug&&console.log("["+c(this)+"] trigger set state",this.state)):"propschange"==t&&this.props!=i[0]&&(this.props=i[0],this.debug&&console.log("["+c(this)+"] trigger set props",this.props))),!this.handlers||!this.handlers[t])return this
for(var o=this.createEvent(t,r),s=0,h=this.handlers[t];s<h.length;s++){(0,h[s])(o)}}else if(this.root){this.debug&&console.log("["+c(this)+"] trigger "+t+" on root="+c(this.root))
var l=new Event(t)
l=__assign(__assign({},l),i),this.root.dispatchEvent(l)}return this.internal&&(this.debug&&console.log("["+c(this)+"] trigger "+t+" on internal="+c(this.internal)),(e=this.internal).trigger.apply(e,__spreadArray([t],i,!1))),this}},e.prototype.unmount=function(){if(this.debug&&console.log("["+c(this)+"] unmount ctx="+c(this.context)+" root="+c(this.root),this.state,this.props),this.componentWillUnmount(),this.internal&&this.internal.unmount(),this.internal=void 0,this.root&&this.root.remove(),this.root=void 0,this.id){var e=t.registry.indexOf(this.id)
e>=0&&t.registry.splice(e,1)}return this.mounted=!1,wuxRegister(this.id,"delete"),this.trigger("unmount"),this},e.prototype.mount=function(i){this.debug&&console.log("["+c(this)+"] mount ctx="+c(i)+" root="+c(this.root),this.state,this.props),this.id||this.root&&(this.id=this.root.id),i&&(this.context=i),this.context||this.root&&(this.context=this.root.parentElement,this.context||(this.context=this.root))
try{if(this.mounted&&this.unmount(),this.mounted=!1,!this.context){var n=document.getElementById(this.id)
n&&(this.context=n)}if(this.debug&&console.log("["+c(this)+"] componentWillMount ctx="+c(i)+" root="+c(this.root)),this.componentWillMount(),this.context){this.debug&&console.log("["+c(this)+"] render ctx="+c(i)+" root="+c(this.root))
var r=this.render()
if(void 0!==r&&null!==r)if(r instanceof e){if(this.debug&&console.log("["+c(this)+"] render -> "+c(r)),this.internal=r,r.parent||(r.parent=this),r.mount(this.context),!this.root)if(this.id){var n=document.getElementById(this.id)
...
d&&d.cuid!=this.cuid&&console.error("["+c(this)+"] id already used by "+c(d))}else t.registry.push(this.id)}this.trigger("mount")}catch(t){var p=c(this)+" "+c(this.context)
console.error("["+c(this)+"] mount error "+p,t),this.componentDidCatch(t,p)}return this},e.prototype.componentWillUnmount=function(){},e.prototype.componentWillMount=function(){},e.prototype.render=function(){return this.buildRoot(this.rootTag)},e.prototype.componentDidMount=function(){},e.prototype.componentDidCatch=function(t,e){},e.prototype.shouldComponentUpdate=function(t,e){return"object"==typeof t||"object"==typeof e||(this.props!=t||this.state!=e)},e.prototype.componentWillUpdate=function(t,e){},e.prototype.componentDidUpdate=function(t,e){},e.prototype.updateProps=function(t){this.props=t},e.prototype.updateState=function(t){this.state=t},e.prototype.update=function(t,e,i,n,r,o){void 0===r&&(r=!1),this.debug&&console.log("["+c(this)+"] update",t,e,"propsChange="+i+",stateChange="+n+",force="+r),t=void 0===t?this.props:t
var s=this.props,h=this.state
if(this.dontTrigger=!1,this.mounted){if(r||this.shouldComponentUpdate(t,e)){try{this.debug&&console.log("["+c(this)+"] componentWillUpdate",t,e),this.componentWillUpdate(t,e),i&&(this.debug&&console.log("["+c(this)+"] updateProps",t),this.updateProps(t)),n&&(this.debug&&console.log("["+c(this)+"] updateState",e),this.updateState(e)),r&&this.mount(),this.debug&&console.log("["+c(this)+"] componentDidUpdate",s,h),this.componentDidUpdate(s,h),i&&!this.dontTrigger&&this.trigger("propschange"),n&&!this.dontTrigger&&this.trigger("statechange")}catch(t){return this.componentDidCatch(t,c(this)+"|"+c(this.context)),!1}o&&o()}}else i&&(this.debug&&console.log("["+c(this)+"] updateProps",t),this.updateProps(t),this.dontTrigger||this.trigger("propschange")),n&&(this.debug&&console.log("["+c(this)+"] updateState",e),this.updateState(e),this.dontTrigger||this.trigger("statechange"))
...
if(!t&&t==this.id)return!1}return!0},e.prototype.buildRoot=function(t,e,i,n,r,o,s){return this.debug&&console.log("["+c(this)+"] buildRoot",t,e,i,n,r,o,s),this.shouldBuildRoot()?(this.debug&&console.log("["+c(this)+"] shouldBuildRoot() -> true"),this.build(t,e,i,n,r,o,s)):void(this.debug&&console.log("["+c(this)+"] shouldBuildRoot() -> false"))},e.prototype.build=function(e,i,n,r,o,s,h){e||(e="div"),void 0===r&&(r=this._classStyle),void 0===o&&(o=this._style),void 0===s&&(s=this._attributes),void 0===h&&(h=this.id)
var l="<"+e
...
return n&&this.id?0!=n.indexOf(this.id+"-")?n:n.substring(this.id.length+1):n}return this.id&&"*"!=this.id||(this.id="w"+this.cuid),t&&"*"!=t||(t=(this.subSeq++).toString()),i||0==i?this.id+"-"+t+"-"+i:this.id+"-"+t},e.prototype.ripId=function(t){return t&&this.id&&0==t.indexOf(this.id)&&t.length>this.id.length+1?t.substring(this.id.length+1):t},e.prototype.transferTo=function(t,e,i){return this.debug&&console.log("["+c(this)+"] transferTo "+c(t)),!!t&&(t.setState(this.getState(),e,i),!0)},e}()
t.WComponent=T,t.getId=e,t.firstSub=i,t.lastSub=n,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=h,t.setState=l,t.getState=a,t.newInstance=u,t.same=d,t.divide=p,t.str=c,t.getTagName=f,t.style=g,t.addStyle=b,t.css=y,t.cls=m,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=_,t.toggleClass=O,t.addClassOf=W,t.removeClassOf=S,t.toggleClassOf=C,t.setCss=U,t.build=k}(WUX||(WUX={}))
var WUX
!function(t){var e={},i={}
...
var WUX
!function(t){function e(e,i,n,r,o){var s,h
"string"==typeof i?i.indexOf(":")>0?h=i:s=i:i&&(i.n&&(s=i.n),h=t.style(i)),o&&(s?s+=" "+o:s=o)
var l="<"+e
r&&(l+=' id="'+r+'"'),s&&(l+=' class="'+s+'"'),h&&(l+=' style="'+h+'"')
var a=t.attributes(n)
return a&&(l+=" "+a),l+=">"}t._t=e
var i=function(e){function i(i,n,r,o,s,h){var l=e.call(this,i||"*","WContainer",h,n,t.style(r),o)||this
...
t.WContainer=i
var n=function(i){function n(t,e,n,r,o,s,h){var l=i.call(this,t||"*","WTable",h,r,o,s)||this
if(l.rootTag="table",l.header=e,n&&n.length)l.keys=n
else if(l.keys=[],l.header)for(var a=0;a<l.header.length;a++)l.keys.push(a)
return l.widths=[],l}return __extends(n,i),n.prototype.render=function(){if(this.shouldBuildRoot()){var e="table"
...
"w"==this.getType(o)&&(d.a="center"),n+="<th"+t.buildCss(a,d)+">"+l+"</th>"}n+="</tr></thead>"}}return n+='<tbody id="'+this.id+'-b"></tbody>',n+="</table>",this.div&&(n+="</div>"),n}},n.prototype.componentDidMount=function(){this.buildBody()},n.prototype.componentDidUpdate=function(t,e){this.buildBody()},n.prototype.getType=function(t){return this.types?this.types.length<=t?"":this.types[t]:""},n.prototype.buildBody=function(){var i=document.getElementById(this.id+"-b")
if(i){if(!this.state||!this.state.length)return void(i.innerHTML="")
if(!this.keys||!this.keys.length)return void(i.innerHTML="")
for(var n="",r=-1,o=0,s=this.state;o<s.length;o++){var h=s[o]
r++
var l=""
l=r==this.state.length-1&&this.footerStyle?e("tr",this.footerStyle):e("tr",this.rowStyle),n+=l
for(var a=-1,u=0,d=this.keys;u<d.length;u++){var p=d[u],c=h[p],f=""
null==c&&(c=""),a++
switch(this.getType(a)){case"w":f="text-center"
break
...
g=0==a?this.col0Style?this.col0Style:this.colStyle:a==this.header.length-1&&this.colLStyle?this.colLStyle:this.colStyle,"string"==typeof g?g.indexOf("text-align")>0&&(f=""):g&&g.a&&(f="")
var b=this.widths&&this.widths.length>a?this.widths[a]:0
n+="<td"+t.buildCss(g,f,{w:b})+">"+c+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var y=0;y<this.header.length-this.keys.length;y++)n+="<td"+t.buildCss(this.colStyle)+"></td>"
n+="</tr>",i.innerHTML=n}}},n}(t.WComponent)
t.WTable=n}(WUX||(WUX={}))
var APP
