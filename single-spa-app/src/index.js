...
if(!t||!t.length)return""
var n=b.apply(void 0,t),i=m.apply(void 0,t),r=""
...
else if(t instanceof Element){var i=m.apply(void 0,e),r=b.apply(void 0,e)
...
t.WComponent=T,t.getId=e,t.firstSub=n,t.lastSub=i,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=h,t.getState=u,t.newInstance=l,t.same=c,t.divide=d,t.str=f,t.getTagName=p,t.style=g,t.addStyle=y,t.css=m,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=S,t.toggleClass=_,t.addClassOf=C,t.removeClassOf=O,t.toggleClassOf=D,t.setCss=M,t.buildIcon=W,t.build=I
...
t.RES=y,t.formatDate=e,t.isoDate=n,t.formatDateTime=i,t.formatTime=r,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=h,t.formatBoolean=u,t.format=l,t.formatDay=c,t.formatMonth=d}(WUX||(WUX={}))
var WUX
...
n+="<td"+t.buildCss(p,f,{w:g})+">"+d+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var y=0;y<this.header.length-this.keys.length;y++)n+="<td"+t.buildCss(this.colStyle)+"></td>"
...
if(e&&!(e.length<2)){var n=this.root,i=n.getContext("2d")
if(i){var r=this.state.labels,o=0,s=0,a=!1
r&&r.length==e.length&&(o=5*this.fontSize+4,s=2*this.fontSize+4,a=!0)
var h=n.width-this.offx-s,u=n.height-this.offy-o,l=h/(e.length-1),c=Math.max.apply(Math,e)
c||(c=4)
var d=[Math.round(c/4),Math.round(c/2),Math.round(3*c/4)],f=u/c
i.beginPath(),i.lineWidth=2,i.strokeStyle=this.line,i.moveTo(this.offx,n.height-e[0]*f)
for(var p=1;p<e.length;p++){var g=this.offx+p*l,y=n.height-o-e[p]*f
i.lineTo(g,y)}i.stroke(),i.beginPath(),i.lineWidth=1,i.strokeStyle=this.axis,i.moveTo(this.offx,this.offy),i.lineTo(this.offx,n.height-o),i.lineTo(n.width-s,n.height-o),i.stroke(),i.beginPath(),i.setLineDash([4,8]),i.lineWidth=1,i.strokeStyle=this.grid
for(var p=1;p<e.length;p++){var g=this.offx+p*l
i.moveTo(g,this.offy),i.lineTo(g,n.height-o)}i.moveTo(this.offx,this.offy),i.lineTo(n.width-s,this.offy)
for(var m=0,b=d;m<b.length;m++){var v=b[m]
i.moveTo(this.offx,n.height-o-v*f),i.lineTo(n.width-s,n.height-o-v*f)}i.stroke(),i.fillStyle=this.axis,i.font=this.fontSize+"px "+this.fontName,i.fillText("0",0,n.height-o)
for(var x=0,w=d;x<w.length;x++){var v=w[x]
i.fillText(""+v,0,n.height-o-v*f)}if(i.fillText(""+c,0,this.offy),a)for(var p=0;p<e.length;p++){var g=this.offx+p*l
i.save(),i.translate(g-this.fontSize,n.height),i.rotate(-Math.PI/3),i.fillStyle=this.axis,i.fillText(r[p],0,0),i.restore()}}}}}},e}(t.WComponent)
