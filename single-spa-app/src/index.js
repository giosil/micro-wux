...
var r=t.mount(e,n)
if(t.lastCtx=r,o&&o(n),t.onRenderHandlers.length>0){for(var s=e instanceof WUX.WComponent?e:null,a={component:s,element:r,target:r.firstChild,type:"render"},l=0,h=t.onRenderHandlers;l<h.length;l++){(0,h[l])(a)}t.onRenderHandlers=[]}})},t.mount=function(e,n){if(n||(n=t.lastCtx?t.lastCtx:document.getElementById("view-root")),WUX.debug&&console.log("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(n)+"..."),null==e)return void console.error("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(n)+" -> invalid component")
...
if(!n)return e
var i=n.getProps()
return null==i?e:i}function l(t,e){if(t){var n=wuxRegistry[t]
...
var i=e(t),o=e(n)
return i&&o&&i==o}function c(t){if(!t)return["","",""]
if(" "==t)return["","&nbsp;",""]
var e=" "==t.charAt(0)?"&nbsp;":"",n=t.length>1&&" "==t.charAt(t.length-1)?"&nbsp;":"",i=t.trim().split("<>")
return!i||i.length<2?[e,t.trim(),n]:(e+=i[0],2==i.length?[e,i[1],""]:(n+=i[2],[e,i[1],n]))}function d(t){if(t instanceof T){var e=t.name,n=t.id
...
if(!t||!t.length)return""
var n=y.apply(void 0,t),i=b.apply(void 0,t),o=""
...
a!=e?o+=a+" ":i=!0}return i?o.trim():o.trim()+" "+e}function O(t,e){t&&t.setAttribute("class",w(t.getAttribute("class"),e))}function C(t,e){t&&t.setAttribute("class",_(t.getAttribute("class"),e))}function U(t,e){t&&t.setAttribute("class",W(t.getAttribute("class"),e))}function S(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n]
if(!t||!e||!e.length)return t
if(t instanceof T)t.css.apply(t,e)
else if(t instanceof HTMLElement){var i=b.apply(void 0,e),o=y.apply(void 0,e)
o&&O(t,o),i&&t.setAttribute("style",g(i))}return t}function A(e,n,i,o,r,s){e||(e="div")
var a,l
...
if(t)return t}return this.context}return this.root},e.prototype.getState=function(){return this.state},e.prototype.setState=function(t,e,n){return this.debug&&console.log("["+d(this)+"] setState",t),this.update(this.props,t,!1,!0,this.forceOnChange||e,n),this},e.prototype.getProps=function(){return this.props},e.prototype.setProps=function(t,e,n){return this.debug&&console.log("["+d(this)+"] setProps",t),this.update(t,this.state,!0,!1,this.forceOnChange||e,n),this},e.prototype.on=function(t,e){if(!t)return this
...
if(this.root)for(var r=this.handlers[o],s=0,a=r;s<a.length;s++){var l=a[s]
this.root.removeEventListener(o,l)}delete this.handlers[o]}else this.handlers={}
...
if(this.debug&&console.log("["+d(this)+"] trigger",t,n),t){var o=n&&n.length>0?n[0]:void 0
if("_"==t.charAt(0)||"mount"==t||"unmount"==t||"statechange"==t||"propschange"==t){if(void 0!==o&&("statechange"==t?this.state!=n[0]&&(this.state=n[0],this.debug&&console.log("["+d(this)+"] trigger set state",this.state)):"propschange"==t&&this.props!=n[0]&&(this.props=n[0],this.debug&&console.log("["+d(this)+"] trigger set props",this.props))),!this.handlers||!this.handlers[t])return this
for(var r=this.createEvent(t,o),s=0,a=this.handlers[t];s<a.length;s++){(0,a[s])(r)}}else if(this.root){this.debug&&console.log("["+d(this)+"] trigger "+t+" on root="+d(this.root))
var l=new Event(t)
l=__assign(__assign({},l),n),this.root.dispatchEvent(l)}return this.internal&&(this.debug&&console.log("["+d(this)+"] trigger "+t+" on internal="+d(this.internal)),(e=this.internal).trigger.apply(e,__spreadArray([t],n,!1))),this}},e.prototype.unmount=function(){if(this.debug&&console.log("["+d(this)+"] unmount ctx="+d(this.context)+" root="+d(this.root),this.state,this.props),this.componentWillUnmount(),this.internal&&this.internal.unmount(),this.internal=void 0,this.root&&this.root.remove(),this.root=void 0,this.id){var e=t.registry.indexOf(this.id)
e>=0&&t.registry.splice(e,1)}return this.mounted=!1,wuxRegister(this.id,"delete"),this.trigger("unmount"),this},e.prototype.mount=function(n){this.debug&&console.log("["+d(this)+"] mount ctx="+d(n)+" root="+d(this.root),this.state,this.props),this.id||this.root&&(this.id=this.root.id),n&&(this.context=n),this.context||this.root&&(this.context=this.root.parentElement,this.context||(this.context=this.root))
try{if(this.mounted&&this.unmount(),this.mounted=!1,!this.context){var i=document.getElementById(this.id)
i&&(this.context=i)}if(this.debug&&console.log("["+d(this)+"] componentWillMount ctx="+d(n)+" root="+d(this.root)),this.componentWillMount(),this.context){this.debug&&console.log("["+d(this)+"] render ctx="+d(n)+" root="+d(this.root))
var o=this.render()
if(void 0!==o&&null!==o)if(o instanceof e){if(this.debug&&console.log("["+d(this)+"] render -> "+d(o)),this.internal=o,o.parent||(o.parent=this),o.mount(this.context),!this.root)if(this.id){var i=document.getElementById(this.id)
...
r||(r=""),this.context.innerHTML=r+o
var s=this.context.lastChild
s instanceof HTMLElement&&(this.root=s),this.root||(this.root=this.id?document.getElementById(this.id):this.context)}else this.internal&&this.internal.mount(this.context),this.root||(this.root=this.id?document.getElementById(this.id):this.context)}if(this._visible||(this.internal?this.internal.visible=!1:this.root.style.display="none"),this._enabled||(this.internal?this.internal.enabled=!1:this.root.setAttribute("disabled","")),this.debug&&console.log("["+d(this)+"] componentDidMount ctx="+d(n)+" root="+d(this.root)),this.componentDidMount(),this.root)for(var a in this.handlers)if(a&&"_"!=a.charAt(0)&&"mount"!=a&&"unmount"!=a&&"statechange"!=a&&"propschange"!=a)for(var l=0,h=this.handlers[a];l<h.length;l++){var u=h[l]
this.root.addEventListener(a,u)}if(wuxRegister(this.root,this),this.mounted=!0,this.id&&(!this.internal||this.internal.id!=this.id)){if(t.registry.indexOf(this.id)>=0){var p=t.getComponent(this.id)
p&&p.cuid!=this.cuid&&console.error("["+d(this)+"] id already used by "+d(p))}else t.registry.push(this.id)}this.trigger("mount")}catch(t){var c=d(this)+" "+d(this.context)
console.error("["+d(this)+"] mount error "+c,t),this.componentDidCatch(t,c)}return this},e.prototype.componentWillUnmount=function(){},e.prototype.componentWillMount=function(){},e.prototype.render=function(){return this.buildRoot(this.rootTag)},e.prototype.componentDidMount=function(){},e.prototype.componentDidCatch=function(t,e){},e.prototype.shouldComponentUpdate=function(t,e){return"object"==typeof t||"object"==typeof e||(this.props!=t||this.state!=e)},e.prototype.componentWillUpdate=function(t,e){},e.prototype.componentDidUpdate=function(t,e){},e.prototype.updateProps=function(t){this.props=t},e.prototype.updateState=function(t){this.state=t},e.prototype.update=function(t,e,n,i,o,r){void 0===o&&(o=!1),this.debug&&console.log("["+d(this)+"] update",t,e,"propsChange="+n+",stateChange="+i+",force="+o),t=void 0===t?this.props:t
var s=this.props,a=this.state
if(this.dontTrigger=!1,this.mounted){if(o||this.shouldComponentUpdate(t,e)){try{this.debug&&console.log("["+d(this)+"] componentWillUpdate",t,e),this.componentWillUpdate(t,e),n&&(this.debug&&console.log("["+d(this)+"] updateProps",t),this.updateProps(t)),i&&(this.debug&&console.log("["+d(this)+"] updateState",e),this.updateState(e)),o&&this.mount(),this.debug&&console.log("["+d(this)+"] componentDidUpdate",s,a),this.componentDidUpdate(s,a),n&&!this.dontTrigger&&this.trigger("propschange"),i&&!this.dontTrigger&&this.trigger("statechange")}catch(t){return this.componentDidCatch(t,d(this)+"|"+d(this.context)),!1}r&&r()}}else n&&(this.debug&&console.log("["+d(this)+"] updateProps",t),this.updateProps(t),this.dontTrigger||this.trigger("propschange")),i&&(this.debug&&console.log("["+d(this)+"] updateState",e),this.updateState(e),this.dontTrigger||this.trigger("statechange"))
...
if(!t&&t==this.id)return!1}return!0},e.prototype.buildRoot=function(t,e,n,i,o,r,s){return this.debug&&console.log("["+d(this)+"] buildRoot",t,e,n,i,o,r,s),this.shouldBuildRoot()?(this.debug&&console.log("["+d(this)+"] shouldBuildRoot() -> true"),this.build(t,e,n,i,o,r,s)):void(this.debug&&console.log("["+d(this)+"] shouldBuildRoot() -> false"))},e.prototype.build=function(e,n,i,o,r,s,a){e||(e="div"),void 0===o&&(o=this._classStyle),void 0===r&&(r=this._style),void 0===s&&(s=this._attributes),void 0===a&&(a=this.id)
var l="<"+e
...
return i&&this.id?0!=i.indexOf(this.id+"-")?i:i.substring(this.id.length+1):i}return this.id&&"*"!=this.id||(this.id="w"+this.cuid),t&&"*"!=t||(t=(this.subSeq++).toString()),n||0==n?this.id+"-"+t+"-"+n:this.id+"-"+t},e.prototype.ripId=function(t){return t&&this.id&&0==t.indexOf(this.id)&&t.length>this.id.length+1?t.substring(this.id.length+1):t},e.prototype.transferTo=function(t,e,n){return this.debug&&console.log("["+d(this)+"] transferTo "+d(t)),!!t&&(t.setState(this.getState(),e,n),!0)},e}()
t.WComponent=T,t.getId=e,t.firstSub=n,t.lastSub=i,t.getComponent=o,t.getRootComponent=r,t.setProps=s,t.getProps=a,t.setState=l,t.getState=h,t.newInstance=u,t.same=p,t.divide=c,t.str=d,t.getTagName=f,t.style=g,t.addStyle=m,t.css=b,t.cls=y,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=_,t.toggleClass=W,t.addClassOf=O,t.removeClassOf=C,t.toggleClassOf=U,t.setCss=S,t.build=A}(WUX||(WUX={}))
var WUX
!function(t){var e={},n={}
t.global={locale:"it",main_class:"container-fluid",con_class:"container",init:function(e){t.debug&&console.log("[WUX] global.init..."),t.debug&&console.log("[WUX] global.init completed"),e&&e()},setData:function(t,i,o){if(void 0===o&&(o=!1),t||(t="global"),e[t]=i,!o&&n[t])for(var r=0,s=n[t];r<s.length;r++){var a=s[r]
a(i)}},getData:function(t,n){t||(t="global")
var i=e[t]
...
t.WHtml=e
var n=function(n){function i(e,i,o,r,s,a){var l=n.call(this,e,"WContainer",a,i,t.style(o),r)||this
return l.components=[],l.rootTag=s?"span":"div","aside"==a&&(l.rootTag="aside"),l}return __extends(i,n),i.prototype.end=function(){return this.parent instanceof i?this.parent.end():this},i.prototype.grid=function(){return"row"==this.props&&this.parent instanceof i?this.parent:this.parent instanceof i?this.parent.grid():this},i.prototype.row=function(){if("row"==this.props)return this
...
if(e instanceof i&&"row"==e.getProps())return e}return this}return this.parent instanceof i?this.parent.row():this},i.prototype.col=function(){return"col"==this.props?this:this.parent instanceof i?this.parent.col():this},i.prototype.add=function(n){if(!n)return this
n instanceof t.WComponent&&(n.parent||(n.parent=this))
var i
return"string"==typeof n&&n.length>0&&"<"==n.charAt(0)&&">"==n.charAt(n.length-1)&&(i=new e(n)),i||(i=n),this.components.push(i),this},i.prototype.remove=function(t){if(t<0&&(t=this.components.length+t),!(t<0||t>=this.components.length))return this.components.splice(t,1),this},i.prototype.removeAll=function(){if(this.mounted){this.parent=null
for(var e=0,n=this.components;e<n.length;e++){var i=n[e]
i instanceof t.WComponent&&i.unmount()}}return this.components=[],this},i.prototype.addRow=function(t,e,n,o){var r=null==t?"row":t,s=new i(n,r,e,o,!1,"row")
return s.name=s.name+"_row",this.grid().addContainer(s)},i.prototype.addCol=function(t,e,n,o){isNaN(parseInt(t))||(t="col-md-"+t)
var r=null==t?"col":t,s=new i(n,r,e,o,!1,"col")
return s.name=s.name+"_col",this.row().addContainer(s)},i.prototype.addText=function(e,n,i,o,r,s){if(!e||!e.length)return this
var a=""
...
continue}}h+=n&&"br"!=n?"<"+n+">"+c+"</"+a+">":c+"<br>"}return i||o||r||s?this.add(t.build("div",h,o,s,r,i)):this.add(h),this},i.prototype.addContainer=function(e,n,o,r,s,a){if(e instanceof i)return null==this._classStyle&&e._classStyle&&0==e._classStyle.indexOf("row")&&(this.parent instanceof i?this._classStyle=t.global.con_class:this._classStyle=t.global.main_class),e.parent=this,this.components.push(e),e
if("string"==typeof e){var l=new i(e,n,o,r,s,a)
return this.components.push(l),l}},i.prototype.render=function(){return this.parent||this._classStyle||this._style?this.build(this.rootTag):this.buildRoot(this.rootTag)},i.prototype.componentDidMount=function(){for(var e=0,n=this.components;e<n.length;e++){var i=n[e]
i instanceof t.WComponent?i.mount(this.root):this.root.append(i)}},i.prototype.componentWillUnmount=function(){for(var e=0,n=this.components;e<n.length;e++){var i=n[e]
i instanceof t.WComponent&&i.unmount()}},i.prototype.rebuild=function(){this.root.innerHTML=""
for(var e=0,n=this.components;e<n.length;e++){var i=n[e]
i instanceof t.WComponent?i.mount(this.root):this.root.append(i)}return this},i}(t.WComponent)
