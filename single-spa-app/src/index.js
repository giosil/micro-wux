...
t.WComponent=T,t.getId=e,t.firstSub=n,t.lastSub=i,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=h,t.getState=u,t.newInstance=l,t.same=d,t.divide=c,t.str=f,t.getTagName=p,t.style=g,t.addStyle=y,t.css=m,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=S,t.toggleClass=_,t.addClassOf=C,t.removeClassOf=O,t.toggleClassOf=D,t.setCss=M,t.buildIcon=W,t.build=I
...
t.RES=y,t.formatDate=e,t.isoDate=n,t.formatDateTime=i,t.formatTime=r,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=h,t.formatBoolean=u,t.format=l,t.formatDay=d,t.formatMonth=c}(WUX||(WUX={}))
var WUX
...
n+="<td"+t.buildCss(p,f,{w:g})+">"+c+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var y=0;y<this.header.length-this.keys.length;y++)n+="<td"+t.buildCss(this.colStyle)+"></td>"
...
return s.readonly=i,this.currRow.push({id:r,label:n,component:s,readonly:i,type:"email"}),this},i.prototype.addOptionsField=function(e,n,i,r,o){var s=this.subId(e),a=new u(s,i,!1,t.CSS.FORM_CTRL,"",r)
...
if(o&&o.length==e.length){var u=o[0],l=u?u.length:0,d=l>4?Math.ceil(l/2):2
