...
var o=t.mount(e,n)
if(t.lastCtx=o,r&&r(n),t.onRenderHandlers.length>0){for(var s=e instanceof WUX.WComponent?e:null,a={component:s,element:o,target:o.firstChild,type:"render"},h=0,u=t.onRenderHandlers;h<u.length;h++){(0,u[h])(a)}t.onRenderHandlers=[]}})},t.mount=function(e,n){if(n||(n=t.lastCtx?t.lastCtx:document.getElementById("view-root")),WUX.debug&&console.log("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(n)+"..."),null==e)return void console.error("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(n)+" -> invalid component")
...
return o&&o.prototype?Object.create(o.prototype):null}function c(t,n){if("string"==typeof t&&"string"==typeof n)return t==n
...
if(!e)return t
for(var n=t.split(" "),i=0,r=n;i<r.length;i++){if(r[i]==e)return t}return t+" "+e}function S(t,e){if(!t||!e)return t
...
a!=e?r+=a+" ":i=!0}return i?r.trim():r.trim()+" "+e}function C(t,e){t&&t.setAttribute("class",w(t.getAttribute("class"),e))}function O(t,e){t&&t.setAttribute("class",S(t.getAttribute("class"),e))}function D(t,e){t&&t.setAttribute("class",_(t.getAttribute("class"),e))}function M(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n]
...
l&&(u+=" "+l),u+=">"
var c=d(n)
return u+=c[1],"input"==e?c[0]+u+c[2]:(u+="</"+e+">",c[0]+u+c[2])}t.debug=!1,t.registry=[],t.version="1.0.0"
...
l&&(h+=" "+l),h+=">"
var c=d(null==n?this.make():n)
return h+=c[1],"input"==e?c[0]+h+c[2]:(h+="</"+e+">",c[0]+h+c[2])},e.prototype.make=function(){return""},e.prototype.subId=function(t,n){if(t instanceof e){var i=t.id
...
t.WComponent=T,t.getId=e,t.firstSub=n,t.lastSub=i,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=h,t.getState=u,t.newInstance=l,t.same=c,t.divide=d,t.str=f,t.getTagName=p,t.style=g,t.addStyle=m,t.css=y,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=S,t.toggleClass=_,t.addClassOf=C,t.removeClassOf=O,t.toggleClassOf=D,t.setCss=M,t.buildIcon=W,t.build=I
...
n||(n=new Date)
var i=""+n.getFullYear(),r=n.getMonth()+1,o=r<10?"0"+r:""+r,s=n.getDate(),a=s<10?"0"+s:""+s,h=n.getHours(),u=h<10?"0"+h:""+h,l=n.getMinutes(),c=l<10?"0"+l:""+l,d=n.getSeconds()
return i+o+a+u+c+(d<10?"0"+d:""+d)},e.nvl=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
var o=i.getTime()-r.getTime(),s=o/864e5,a=o%864e5,h=a/6e4,u=s
return h>12&&u++,u},e}()
t.WUtil=k}(WUX||(WUX={}))
var WUX
...
if(n){var c=o.getSeconds()<10?"0"+o.getSeconds():""+o.getSeconds()
return i?t.formatDay(o.getDay(),r)+", "+h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l+":"+c:h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l+":"+c}return i?t.formatDay(o.getDay(),r)+", "+h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l:h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l}function r(t,e){if(void 0===e&&(e=!1),null==t)return""
...
return r(parseInt(t.replace(":","").replace(".","")))}if(t instanceof Date){var u=t.getHours()<10?"0"+t.getHours():""+t.getHours(),l=t.getMinutes()<10?"0"+t.getMinutes():""+t.getMinutes()
if(e){var a=t.getSeconds()<10?"0"+t.getSeconds():""+t.getSeconds()
return u+":"+l+":"+a}return u+":"+l}return""}function o(e,n,i,r){if(""===e||null==e)return""
...
if(a<0&&(s+=",00"),a==s.length-2&&(s+="0"),a>0){for(var h=s.substring(0,a),u=s.substring(a),l="",c=1;c<=h.length;c++)c>3&&(c-1)%3==0&&(l="."+l),l=h.charAt(h.length-c)+l
s=l+u}return null!=n&&0!=o?null!=r&&o<0?r.replace("$",s):n.replace("$",s):null!=i&&0==o?i.replace("$",s):s}function u(t){return null==t?"":t?"S":"N"}function l(e){if(null==e)return""
if("string"==typeof e)return e
if("boolean"==typeof e)return t.formatBoolean(e)
if("number"==typeof e){return(""+e).indexOf(".")>=0?t.formatCurr(e):t.formatNum(e)}return e instanceof Date?t.formatDate(e):e instanceof t.WComponent?t.format(e.getState()):""+e}function c(t,e){switch(t){case 0:return e?"Domenica":"Dom"
...
case 6:return e?"Sabato":"Sab"}return""}function d(t,e,n){switch(t>100&&(n=Math.floor(t/100),t%=100),n=n?" "+n:"",t){case 1:return e?"Gennaio"+n:"Gen"+n
...
t.RES=m,t.formatDate=e,t.isoDate=n,t.formatDateTime=i,t.formatTime=r,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=h,t.formatBoolean=u,t.format=l,t.formatDay=c,t.formatMonth=d}(WUX||(WUX={}))
var WUX
...
var n='name="'+this.id+'"'
return n+=this.props?' type="'+this.props+'"':' type="text"',this.size&&(n+=' size="'+this.size+'"'),this.state&&(n+=' value="'+this.state+'"'),this.placeHolder&&(n+=' placeholder="'+this.placeHolder+'"'),t+this.build(this.rootTag,"",n)},e}(t.WComponent)
t.WInput=o
...
t.WCheck=h
var u=function(e){function n(t,n,i,r,o,s){var a=e.call(this,t||"*","WSelect",null,r,o,s)||this
...
t.WSelect=u
var l=function(e){function n(t,n,i,r,o,s,a){var h=e.call(this,t||"*","WTable",a,r,o,s)||this
if(h.rootTag="table",h.header=n,i&&i.length)h.keys=i
else if(h.keys=[],h.header)for(var u=0;u<h.header.length;u++)h.keys.push(u)
return h.widths=[],h}return __extends(n,e),n.prototype.render=function(){if(this.sortable&&this.sortable.length){this.soId=[],this.sortBy=[]
...
var c=this.widths&&this.widths.length>s?this.widths[s]:0,d={}
c&&(d.w=this.widthsPerc?c+"%":c)
"w"==this.getType(s)&&(d.a="center")
if(this.sortable&&this.sortable.indexOf(s)>=0){var f=this.subId("sort_"+s)
this.soId.push(f),r+="<th"+t.buildCss(l,d)+'><a style="cursor:pointer;text-decoration:none !important;" id="'+f+'">'+u+' &nbsp;<i class="fa fa-unsorted"></i></a></th>'}else r+="<th"+t.buildCss(l,d)+">"+u+"</th>"}r+="</tr></thead>"}}return r+='<tbody id="'+this.id+'-b"></tbody>',r+="</table>",this.div&&(r+="</div>"),r},n.prototype.componentDidMount=function(){var e=this
if(this.buildBody(),this.soId)for(var n=0,i=this.soId;n<i.length;n++){var r=i[n]
!function(n){var i=document.getElementById(n)
i&&(i.onclick=function(n){var r=t.lastSub(t.getId(n.currentTarget)),o=r.indexOf("_")
if(!(o<=0)){var s=t.WUtil.toNumber(r.substring(o+1),-1)
if(s>=0&&e.keys.length>s){var a=e.header?e.header[s]:"",h=e.sortBy[s]
if(h?1==h?(e.sortBy[s]=-1,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-sort-desc"></i>')):-1==h&&(e.sortBy[s]=0,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-unsorted"></i>')):(e.sortBy[s]=1,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-sort-asc"></i>')),e.handlers._sort)for(var u=0,l=e.handlers._sort;u<l.length;u++){var c=l[u]
c(e.createEvent("_sort",e.sortBy))}}}})}(r)}},n.prototype.componentDidUpdate=function(t,e){this.buildBody()},n.prototype.getType=function(t){return this.types?this.types.length<=t?"":this.types[t]:""},n.prototype.buildBody=function(){var e=document.getElementById(this.id+"-b")
...
i++
var a=""
a=i==this.state.length-1&&this.footerStyle?"<tr"+t.buildCss(this.footerStyle)+">":"<tr"+t.buildCss(this.rowStyle)+">",n+=a
for(var h=-1,u=0,l=this.keys;u<l.length;u++){var c=l[u],d=s[c],f=""
null==d&&(d=""),h++
switch(this.getType(h)){case"w":f="text-center"
break
case"c":case"c5":case"i":case"n":f="text-right"
break
case"b":d=d?"&check;":""
break
default:d instanceof Date&&(d=d.toLocaleDateString()),"boolean"==typeof d&&(d=d?"&check;":""),"number"==typeof d&&(f="text-right")}var p=void 0
p=0==h?this.col0Style?this.col0Style:this.colStyle:h==this.header.length-1&&this.colLStyle?this.colLStyle:this.colStyle,"string"==typeof p?p.indexOf("text-align")>0&&(f=""):p&&p.a&&(f="")
var g=this.widths&&this.widths.length>h?this.widths[h]:0
n+="<td"+t.buildCss(p,f,{w:g})+">"+d+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var m=0;m<this.header.length-this.keys.length;m++)n+="<td"+t.buildCss(this.colStyle)+"></td>"
n+="</tr>",e.innerHTML=n}}},n.prototype.onSort=function(t){this.handlers._sort||(this.handlers._sort=[]),this.handlers._sort.push(t)},n}(t.WComponent)
t.WTable=l
var c=function(e){function i(n,i,r){var o=e.call(this,n||"*","WFormPanel")||this
...
return this.currRow.push({id:r,label:n,component:s,readonly:i,type:"text"}),this},i.prototype.addNoteField=function(e,n,i,r){i||(i=3)
var o=this.subId(e),a=new s(o,i,t.CSS.FORM_CTRL)
return this.currRow.push({id:o,label:n,component:a,readonly:r,type:"note"}),this},i.prototype.addDateField=function(e,n,i){var r=this.subId(e),s=new o(r,"date",0,t.CSS.FORM_CTRL)
return this.currRow.push({id:r,label:n,component:s,readonly:i,type:"date"}),this},i.prototype.addTimeField=function(e,n,i){var r=this.subId(e),s=new o(r,"time",0,t.CSS.FORM_CTRL)
return this.currRow.push({id:r,label:n,component:s,readonly:i,type:"time"}),this},i.prototype.addEmailField=function(e,n,i){var r=this.subId(e),s=new o(r,"email",0,t.CSS.FORM_CTRL)
return this.currRow.push({id:r,label:n,component:s,readonly:i,type:"email"}),this},i.prototype.addOptionsField=function(e,n,i,r,o){var s=this.subId(e),a=new u(s,i,!1,t.CSS.FORM_CTRL,"",r)
...
if(u.component){var c=Math.floor(12/s)
if(c<1&&(c=1),1==c&&s<11&&(0==a||a==s-1)&&(c=2),u.span&&u.span>0&&(c*=u.span),this.main.addCol(""+c),u.component.setState(u.value),u.component instanceof h){if(!this.checkboxStyle){var d=getComputedStyle(this.context).getPropertyValue("font-size"),f=Math.round(.8*parseInt(d));(isNaN(f)||f<18)&&(f=18),this.checkboxStyle="height:"+f+"px;"}u.component.style=this.checkboxStyle}if(u.label&&!u.labelComp){var p=new r(u.id+"-l",u.label,"",u.classStyle)
u.labelComp=p.for(u.id)}l?this.main.addGroup({classStyle:t.CSS.FORM_GROUP},u.labelComp,u.component):(this.main.add(u.labelComp),this.main.add(u.component))}}}if(this.footer&&this.footer.length){this.foot=new n(this.subId("__foot"),this.footerClass,this.footerStyle)
for(var g=0,m=this.footer;g<m.length;g++){var u=m[g]
this.foot.addRow().addCol("12").add(u,"push")}this.main.addRow().addCol("12").add(this.foot)}this.main.mount(this.root)},i.prototype.componentWillUnmount=function(){this.main||this.main.unmount()},i.prototype.clear=function(){for(var t=0;t<this.rows.length;t++)for(var e=this.rows[t],n=0;n<e.length;n++){var i=e[n]
...
return o.am=[],o.mt={},o.ct="table",o.cd="table-responsive",o.ct="table",o.sp="padding:1rem;text-align:center;font-weight:bold;background-color:#eeeeee;",o.sm=o.sp,o.sn=o.sp,o.sw="text-align:center;",o.sd="text-align:center;",o.so="text-align:center;background-color:#f6f6f6;cursor:pointer;",o.ss="text-align:center;background-color:#d9e2f3;",o.sk="text-align:center;background-color:#ffe66d;",o.se="background-color:#f0f0f0;",o.st="font-weight:bold;",o.td=o.str(new Date),o}return __extends(n,e),n.prototype.onDoubleClick=function(t){this.handlers._doubleclick||(this.handlers._doubleclick=[]),this.handlers._doubleclick.push(t)},n.prototype.updateState=function(t){this.state=t,this.state||(this.state=new Date)
...
for(var e='<div class="'+this.cd+'"><table id="'+this.subId("t")+'" class="'+this.ct+'"><thead><tr>',n=0;n<7;n++){var i=6==n?0:n+1
...
return u+='<div class="row"><div class="col-12">'+e+"</div></div>",this.buildRoot(this.rootTag,u)},n.prototype.add=function(e){this.state||(this.state=new Date)
...
this.em.innerText=t.formatMonth(u,!0,!0)}return s},n.prototype.mark=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n]
if(!e||!e.length)return this
...
0==o&&(o=7)
for(var s=new Date(i,n+1,0),a=s.getDate(),h=1,u=1;u<=6;u++){t+="<tr>"
for(var l=1;l<=7;l++)if(1==u&&l<o)t+='<td style="'+this.se+'"></td>'
else if(h>a)t+='<td style="'+this.se+'"></td>'
else{var c=1e4*i+100*(n+1)+h+"",d=c==this.td?this.st:"",f=this.mt[c]
f=f?' title="'+f+'"':"",c==this.ls?t+='<td id="'+this.subId(c)+'" style="'+this.ss+d+'"'+f+">"+h+"</td>":this.am.indexOf(c)>=0?t+='<td id="'+this.subId(c)+'" style="'+this.sk+d+'"'+f+">"+h+"</td>":t+='<td id="'+this.subId(c)+'" style="'+this.sd+d+'"'+f+">"+h+"</td>",h++}if(t+="</tr>",h>a)break}return t},n.prototype.componentDidMount=function(){var e=this
...
for(var h=1;h<this.state.length;h++){var u=this.offx+h*r,l=t.height-this.state[h]*a
...
for(var h=1;h<this.state.length;h++){var u=this.offx+h*r
e.moveTo(u,this.offy),e.lineTo(u,t.height)}e.moveTo(this.offx,this.offy),e.lineTo(t.width,this.offy)
for(var c=0,d=s;c<d.length;c++){var f=d[c]
e.moveTo(this.offx,t.height-f*a),e.lineTo(t.width,t.height-f*a)}e.stroke(),e.fillStyle=this.axis,e.font=this.fontSize+"px "+this.fontName,e.fillText("0",0,t.height)
for(var p=0,g=s;p<g.length;p++){var f=g[p]
e.fillText(""+f,0,t.height-f*a)}e.fillText(""+o,0,this.offy)}}},e}(t.WComponent)
