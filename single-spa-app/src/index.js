...
l&&(u+=" "+l),u+=">"
var d=c(n)
return u+=d[1],"input"==e?d[0]+u+d[2]:(u+="</"+e+">",d[0]+u+d[2])}t.debug=!1,t.registry=[],t.version="1.0.0"
...
this.root.addEventListener(a,l)}if(wuxRegister(this.root,this),this.mounted=!0,this.id&&(!this.internal||this.internal.id!=this.id)){if(t.registry.indexOf(this.id)>=0){var d=t.getComponent(this.id)
...
t.WComponent=T,t.getId=e,t.firstSub=n,t.lastSub=i,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=h,t.getState=u,t.newInstance=l,t.same=d,t.divide=c,t.str=f,t.getTagName=p,t.style=g,t.addStyle=m,t.css=y,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=w,t.removeClass=S,t.toggleClass=_,t.addClassOf=C,t.removeClassOf=O,t.toggleClassOf=D,t.setCss=M,t.buildIcon=W,t.build=I
...
n||(n=new Date)
var i=""+n.getFullYear(),r=n.getMonth()+1,o=r<10?"0"+r:""+r,s=n.getDate(),a=s<10?"0"+s:""+s,h=n.getHours(),u=h<10?"0"+h:""+h,l=n.getMinutes(),d=l<10?"0"+l:""+l,c=n.getSeconds()
return i+o+a+u+d+(c<10?"0"+c:""+c)},e.nvl=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
return i?t.formatDay(o.getDay(),r)+", "+h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l+":"+d:h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l+":"+d}return i?t.formatDay(o.getDay(),r)+", "+h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l:h+"/"+a+"/"+o.getFullYear()+" "+u+":"+l}function r(t,e){if(void 0===e&&(e=!1),null==t)return""
...
if(a<0&&(s+=",00"),a==s.length-2&&(s+="0"),a>0){for(var h=s.substring(0,a),u=s.substring(a),l="",d=1;d<=h.length;d++)d>3&&(d-1)%3==0&&(l="."+l),l=h.charAt(h.length-d)+l
...
t.RES=m,t.formatDate=e,t.isoDate=n,t.formatDateTime=i,t.formatTime=r,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=h,t.formatBoolean=u,t.format=l,t.formatDay=d,t.formatMonth=c}(WUX||(WUX={}))
var WUX
...
this.soId.push(f),r+="<th"+t.buildCss(l,c)+'><a style="cursor:pointer;text-decoration:none !important;" id="'+f+'">'+u+' &nbsp;<i class="fa fa-unsorted"></i></a></th>'}else r+="<th"+t.buildCss(l,c)+">"+u+"</th>"}r+="</tr></thead>"}}return r+='<tbody id="'+this.id+'-b"></tbody>',r+="</table>",this.div&&(r+="</div>"),r},n.prototype.componentDidMount=function(){var e=this
...
if(h?1==h?(e.sortBy[s]=-1,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-sort-desc"></i>')):-1==h&&(e.sortBy[s]=0,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-unsorted"></i>')):(e.sortBy[s]=1,a&&(i.innerHTML=a+' &nbsp;<i class="fa fa-sort-asc"></i>')),e.handlers._sort)for(var u=0,l=e.handlers._sort;u<l.length;u++){var d=l[u]
d(e.createEvent("_sort",e.sortBy))}}}})}(r)}},n.prototype.componentDidUpdate=function(t,e){this.buildBody()},n.prototype.getType=function(t){return this.types?this.types.length<=t?"":this.types[t]:""},n.prototype.buildBody=function(){var e=document.getElementById(this.id+"-b")
...
for(var h=-1,u=0,l=this.keys;u<l.length;u++){var d=l[u],c=s[d],f=""
null==c&&(c=""),h++
...
case"b":c=c?"&check;":""
break
default:c instanceof Date&&(c=c.toLocaleDateString()),"boolean"==typeof c&&(c=c?"&check;":""),"number"==typeof c&&(f="text-right")}var p=void 0
...
n+="<td"+t.buildCss(p,f,{w:g})+">"+c+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var m=0;m<this.header.length-this.keys.length;m++)n+="<td"+t.buildCss(this.colStyle)+"></td>"
...
if(u.component){var d=Math.floor(12/s)
if(d<1&&(d=1),1==d&&s<11&&(0==a||a==s-1)&&(d=2),u.span&&u.span>0&&(d*=u.span),this.main.addCol(""+d),u.component.setState(u.value),u.component instanceof h){if(!this.checkboxStyle){var c=getComputedStyle(this.context).getPropertyValue("font-size"),f=Math.round(.8*parseInt(c));(isNaN(f)||f<18)&&(f=18),this.checkboxStyle="height:"+f+"px;"}u.component.style=this.checkboxStyle}if(u.label&&!u.labelComp){var p=new r(u.id+"-l",u.label,"",u.classStyle)
...
var WUX
!function(t){function e(t){var e=window.$?window.$:null
return e||(e=window.jQuery?window.jQuery:null),e?e(t):(console.error("[WUX] JQuery not available"),null)}t.JQ=e
...
for(var d=0,c=s;d<c.length;d++){var f=c[d]
