...
var __assign=this&&this.__assign||function(){return __assign=Object.assign||function(t){for(var e,i=1,n=arguments.length;i<n;i++){e=arguments[i]
...
t(e,i),e.prototype=null===i?Object.create(i):(n.prototype=i.prototype,new n)}}(),WuxDOM=function(){function t(){}return t.onRender=function(e){t.renderHandlers.push(e)},t.onUnmount=function(e){t.unmountHandlers.push(e)},t.getLastContext=function(){return t.lastCtx},t.register=function(e,i){if(e){var n
if(n="string"==typeof e?0==e.indexOf("#")?e.substring(1):e:e.id,!i)return t.components[n]
if("string"==typeof i){var r=t.components[n]
return r&&delete t.components[n],r}return t.components[n]=i,i}},t.render=function(e,i,n,r){WUX.debug&&console.log("WuxDOM.render "+WUX.str(e)+" on "+WUX.str(i)+"..."),WUX.global.init(function(){i||(i=t.lastCtx?t.lastCtx:document.getElementById("view-root")),n&&n(i)
var o=t.mount(e,i)
if(t.lastCtx=o,r&&r(i),t.renderHandlers.length>0){for(var s=e instanceof WUX.WComponent?e:null,a={component:s,element:o,target:o.firstChild,type:"render"},h=0,l=t.renderHandlers;h<l.length;h++){(0,l[h])(a)}t.renderHandlers=[]}})},t.mount=function(e,i){if(i||(i=t.lastCtx?t.lastCtx:document.getElementById("view-root")),WUX.debug&&console.log("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(i)+"..."),null==e)return void console.error("WuxDOM.mount "+WUX.str(e)+" on "+WUX.str(i)+" -> invalid component")
...
if(t.lastCtx=n,e instanceof WUX.WComponent)e.mount(n),t.register(n,e)
...
var n=t.register(i,"delete")
if(n&&n.unmount(),i.remove(),WUX.debug&&console.log("WuxDOM.unmount "+WUX.str(e)+" completed."),t.unmountHandlers.length>0){for(var r={component:n,element:i,target:i.firstChild,type:"unmount"},o=0,s=t.unmountHandlers;o<s.length;o++){(0,s[o])(r)}t.unmountHandlers=[]}return i},t.replace=function(e,i){var n
...
return n||(n=document.getElementById("#view-root")),n?t.mount(i,n):void console.error("WuxDOM.replace "+WUX.str(n)+" -> node unavailable")},t.components={},t.renderHandlers=[],t.unmountHandlers=[],t}(),WUX
!function(t){function e(t){if(t)return t instanceof Element?t.id:t instanceof k?t.id:"string"==typeof t&&t.indexOf("<")<0?0==t.indexOf("#")?t.substring(1):t:"object"!=typeof t||t.id?"":""+t.id}function i(t,i){var n=e(t)
if(!n)return""
var r=n.indexOf("-")
...
var n=i.lastIndexOf("-")
if(n<0)return i
if(n>0){if("-"==i.charAt(n-1))return i.substring(n)}return i.substring(n+1)}function r(t){if(t)return WuxDOM.components[t]}function o(t){return t&&t.parent?o(t.parent):t}function s(t,e){if(t){var i=WuxDOM.components[t]
if(i)return i.setProps(e),i}}function a(t,e){if(!t)return e
var i=WuxDOM.components[t]
if(!i)return e
var n=i.getProps()
return null==n?e:n}function h(t,e){if(t){var i=WuxDOM.components[t]
...
var n=e(t),r=e(i)
return n&&r&&n==r}function c(t,e){return e?null==t?"string"==typeof e?""==e:!e.id:"object"==typeof t?"string"==typeof e?e==t.id:e.id==t.id:"string"==typeof e?e==t:e.id==t:!t}function f(t){if(!t)return["","",""]
if(" "==t)return["","&nbsp;",""]
var e=" "==t.charAt(0)?"&nbsp;":"",i=t.length>1&&" "==t.charAt(t.length-1)?"&nbsp;":"",n=t.trim().split("<>")
return!n||n.length<2?[e,t.trim(),i]:(e+=n[0],2==n.length?[e,n[1],""]:(i+=n[2],[e,n[1],i]))}function p(t){if(t instanceof k){var e=t.name,i=t.id
return e||(e="WComponent"),i?e+"("+i+")":e}return t instanceof Element?"Element#"+t.id:"object"==typeof t?JSON.stringify(t):t+""}function g(e){if(!e)return""
if(e instanceof k){var i=e.rootTag
...
for(var o=this.createEvent(t,r),s=0,a=this.handlers[t];s<a.length;s++){(0,a[s])(o)}}else if(this.root){this.debug&&console.log("["+p(this)+"] trigger "+t+" on root="+p(this.root))
var h=new Event(t)
...
e>=0&&t.registry.splice(e,1)}return this.mounted=!1,WuxDOM.register(this.id,"delete"),this.trigger("unmount"),this},e.prototype.mount=function(i){this.debug&&console.log("["+p(this)+"] mount ctx="+p(i)+" root="+p(this.root),this.state,this.props),this.id||this.root&&(this.id=this.root.id),i&&(this.context=i),this.context||this.root&&(this.context=this.root.parentElement,this.context||(this.context=this.root))
...
var r=this.render()
if(r)if(r instanceof e){if(this.debug&&console.log("["+p(this)+"] render -> "+p(r)),this.internal=r,r.parent||(r.parent=this),r.mount(this.context),!this.root)if(this.id){var n=document.getElementById(this.id)
...
s instanceof Element&&(this.root=s),this.root||(this.root=this.id?document.getElementById(this.id):this.context)}else this.internal&&this.internal.mount(this.context),this.root||(this.root=this.id?document.getElementById(this.id):this.context)}if(this._visible||(this.internal?this.internal.visible=!1:this.root instanceof HTMLElement&&(this.root.style.display="none")),this._enabled||(this.internal?this.internal.enabled=!1:this.root.setAttribute("disabled","")),this.debug&&console.log("["+p(this)+"] componentDidMount ctx="+p(i)+" root="+p(this.root)),this.componentDidMount(),this.root)for(var a in this.handlers)if(a&&"_"!=a.charAt(0)&&"mount"!=a&&"unmount"!=a&&"statechange"!=a&&"propschange"!=a)for(var h=0,l=this.handlers[a];h<l.length;h++){var u=l[h]
this.root.addEventListener(a,u)}if(WuxDOM.register(this.root,this),this.mounted=!0,this.id&&(!this.internal||this.internal.id!=this.id)){if(t.registry.indexOf(this.id)>=0){var d=t.getComponent(this.id)
...
if(this.dontTrigger=!1,this.mounted){if(r||this.shouldComponentUpdate(t,e)){try{this.debug&&console.log("["+p(this)+"] componentWillUpdate",t,e),this.componentWillUpdate(t,e),i&&(this.debug&&console.log("["+p(this)+"] updateProps",t),this.updateProps(t)),n&&(this.debug&&console.log("["+p(this)+"] updateState",e),this.updateState(e)),r&&this.mount(),this.debug&&console.log("["+p(this)+"] componentDidUpdate",s,a),this.componentDidUpdate(s,a),i&&!this.dontTrigger&&this.trigger("propschange"),n&&!this.dontTrigger&&this.trigger("statechange")}catch(t){return this.componentDidCatch(t,p(this)+"|"+p(this.context)),!1}o&&o()}}else i&&(this.debug&&console.log("["+p(this)+"] updateProps",t),this.updateProps(t),this.dontTrigger||this.trigger("propschange")),n&&(this.debug&&console.log("["+p(this)+"] updateState",e),this.updateState(e),this.dontTrigger||this.trigger("statechange"))
...
if(!t&&t==this.id)return!1}return!0},e.prototype.buildRoot=function(t,e,i,n,r,o,s){return this.debug&&console.log("["+p(this)+"] buildRoot",t,e,i,n,r,o,s),this.shouldBuildRoot()?(this.debug&&console.log("["+p(this)+"] shouldBuildRoot() -> true"),this.build(t,e,i,n,r,o,s)):void(this.debug&&console.log("["+p(this)+"] shouldBuildRoot() -> false"))},e.prototype.build=function(e,i,n,r,o,s,a){e||(e="div"),void 0===r&&(r=this._classStyle),void 0===o&&(o=this._style),void 0===s&&(s=this._attributes),void 0===a&&(a=this.id)
var h="<"+e
...
t.WComponent=k,t.getId=e,t.firstSub=i,t.lastSub=n,t.getComponent=r,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=h,t.getState=l,t.newInstance=u,t.same=d,t.match=c,t.divide=f,t.str=p,t.getTagName=g,t.style=b,t.addStyle=m,t.css=v,t.cls=y,t.attributes=w,t.buildCss=x,t.addClass=_,t.removeClass=S,t.toggleClass=C,t.addClassOf=O,t.removeClassOf=D,t.toggleClassOf=M,t.setCss=W,t.buildIcon=I,t.build=T
var A=function(){function e(){}return e.toArray=function(t){if(t instanceof k&&(t=t.getState()),null==t)return[]
if(Array.isArray(t))return t
var e=[]
return e.push(t),e},e.toArrayNumber=function(t,i){if(t instanceof k&&(t=t.getState()),null==t)return[]
var n=[]
if(Array.isArray(t))for(var r=0,o=t;r<o.length;r++){var s=o[r],a=e.toNumber(s)
i&&!a||n.push(a)}else{var a=e.toNumber(t)
if(i&&!a)return n
n.push(a)}return n},e.toArrayString=function(t,i){if(t instanceof k&&(t=t.getState()),null==t)return[]
var n=[]
...
o.push(e.toNumber(h))}return o},e.toObject=function(t,e){return t instanceof k&&(t=t.getState()),null==t?e:"object"==typeof t?t:e},e.toString=function(i,n){return void 0===n&&(n=""),i instanceof k&&(i=i.getState()),null==i?n:"string"==typeof i?i:i instanceof Date?t.formatDate(i):"object"==typeof i&&void 0!=i.id?e.toString(i.id,n):Array.isArray(i)&&i.length?e.toString(i[0],n):""+i},e.toText=function(t,i){return void 0===i&&(i=""),e.toString(t,i).replace("<","&lt;").replace(">","&gt;")},e.toNumber=function(t,i){if(void 0===i&&(i=0),t instanceof k&&(t=t.getState()),null==t)return i
...
return isNaN(r)?i:r},e.toInt=function(t,i){if(void 0===i&&(i=0),t instanceof k&&(t=t.getState()),null==t)return i
...
return isNaN(r)?i:r},e.toIntTime=function(t,i){if(void 0===i&&(i=0),t instanceof k&&(t=t.getState()),null==t)return i
...
return!0}return!1},e.toBoolean=function(t,e){return void 0===e&&(e=!1),t instanceof k&&(t=t.getState()),null==t?e:"boolean"==typeof t?t:"string"==typeof t&&t.length?"1YyTtSs".indexOf(t.charAt(0))>=0:!!e},e.toDate=function(t,e){if(t instanceof k&&(t=t.getState()),null==t)return e
...
l.href=h,l.target="_blank",l.rel="noopener noreferrer",l.title=e,l.click(),setTimeout(function(){URL.revokeObjectURL(h)},1e3)}function g(e,i,n){if(!e)return null
if("string"==typeof e){var r=t.lastSub(e)
if(!r)return null
var o=r.indexOf("_")
if(o<=0)return null
var s=r.substring(0,o),a=r.substring(o+1).replace(/\$/g,"-")
return n&&(n=n.toLowerCase()),{name:s,ref:a,idx:t.WUtil.toNumber(a,-1),tag:n,comp:i}}var h=e.target
if(!h)return null
var s=h.tagName
if(!s)return null
if(n&&n.toLowerCase()!=s.toLowerCase())return null
var l=t.getId(h)
if(l){var u=g(l,i,s)
if(u)return u}var d=h.parentElement
if(d){if(!(s=d.tagName))return null
if(n&&n.toLowerCase()!=s.toLowerCase())return null}return l=t.getId(d),g(l,i,s)}function b(t,e,i,n,r,o){"string"==typeof e&&(e=e.replace(/\-/g,"$")),i||(i="a")
var s=n?n.subId(t+"_"+e):t+"_"+e
return i.indexOf("-")>0?'<i id="'+s+'" class="fa '+i+'" style="cursor:pointer;width:100%;"></i>':(r||(r=""),o?o.indexOf(":")>0?"<"+i+' id="'+s+'" style="'+o+'">'+r+"</"+i+">":"<"+i+' id="'+s+'" class="'+o+'">'+r+"</"+i+">":"<"+i+' id="'+s+'" style="cursor:pointer;">'+r+"</"+i+">")}var m={},v={}
t.global={locale:"it",init:function(e){t.debug&&console.log("[WUX] global.init..."),t.debug&&console.log("[WUX] global.init completed"),e&&e()},setData:function(t,e,i){if(void 0===i&&(i=!1),t||(t="global"),m[t]=e,!i&&v[t])for(var n=0,r=v[t];n<r.length;n++){var o=r[n]
o(e)}},getData:function(t,e){t||(t="global")
var i=m[t]
return null==i?e:i},onDataChanged:function(t,e){t||(t="global"),v[t]||(v[t]=[]),v[t].push(e)}}
var y=function(){function t(){}return t.FORM="padding-top:16px;",t.FORM_GROUP="form-group",t.FORM_CTRL="form-control",t.FORM_CHECK="form-check form-check-inline",t.CHECK_STYLE="padding-top:1.5rem;",t.ICON="margin-right:8px;",t.SEL_ROW="primary-bg-a2",t.PRIMARY={bg:"#b8d4f1"},t.SECONDARY={bg:"#d1d7dc"},t.SUCCESS={bg:"#b8ddd0"},t.DANGER={bg:"#f4c7ce"},t.WARNING={bg:"#e6d3b8"},t.INFO={bg:"#e2e2e2"},t.LIGHT={bg:"#f9f8fb"},t}()
t.CSS=y
var w=function(){function t(){}return t.OK="OK",t.CLOSE="Chiudi",t.CANCEL="Annulla",t}()
t.RES=w,t.formatDate=e,t.isoDate=i,t.formatDateTime=n,t.formatTime=r,t.formatNum2=o,t.formatNum=s,t.formatCurr=a,t.formatCurr5=h,t.formatBoolean=l,t.format=u,t.formatDay=d,t.formatMonth=c,t.saveFile=f,t.viewFile=p,t.getAction=g,t.action=b}(WUX||(WUX={}))
var WUX
!function(t){var e=function(t){function e(e,i,n,r,o,s){var a=t.call(this,n,"Wrapp",e,r,o,s)||this
return i&&(a.rootTag=i),a}return __extends(e,t),e.prototype.render=function(){return this.isText=!1,"string"==typeof this.props&&(!this.props||this.props.indexOf("<")<0)?(this.isText=!0,this.buildRoot(this.rootTag,this.props)):this.props},e.prototype.componentDidMount=function(){this.root&&!this.isText&&(this.rootTag=this.root.tagName,this.id=this.root.getAttribute("id"),this._classStyle=this.root.getAttribute("class"),this._style=this.root.getAttribute("style"))},e}(t.WComponent)
t.Wrapp=e
...
return h.rootTag="input",h.value=n||"1",r&&h.updateState(n),h.text=i,h}return __extends(e,t),Object.defineProperty(e.prototype,"checked",{get:function(){return this.root&&(this.props=!!this.root.checked),this.state=this.props?this.value:void 0,this.props},set:function(t){this.setProps(t)},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"tooltip",{set:function(t){this._tooltip=t
var e=document.getElementById(this.id+"-l")
e?e.setAttribute("title",this._tooltip):this.root&&this.root.setAttribute("title",this._tooltip)},enumerable:!1,configurable:!0}),e.prototype.getState=function(){return this.root&&(this.props=!!this.root.checked),this.state=this.props?this.value:void 0,this.state},e.prototype.updateProps=function(e){t.prototype.updateProps.call(this,e),null==this.props&&(this.props=!1),this.state=this.props?this.value:void 0,this.root&&(this.root.checked=this.props)},e.prototype.updateState=function(e){t.prototype.updateState.call(this,e),"boolean"==typeof this.state?(this.props=this.state,this.state=this.props?this.value:void 0):this.props=!this.state&&this.state==this.value,this.root&&(this.root.checked=this.props)},e.prototype.render=function(){var t='name="'+this.id+'" type="checkbox"'
t+=this.props?' checked="checked"':""
var e=this.text?"&nbsp;"+this.text:"",i="",n=""
return(this.divClass||this.divStyle)&&(i+="<div ",this.divClass&&(i+=' class="'+this.divClass+'"'),this.divStyle&&(i+=' style="'+this.divStyle+'"'),i+=">"),this.label?(n+='<label id="'+this.id+'-l" for="'+this.id+'"',this._tooltip&&(n+=' title="'+this._tooltip+'"'),n+=">"+this.label+"</label>"):this._tooltip&&(t+=' title="'+this._tooltip+'"'),i&&(n+="</div>"),i+this.build(this.rootTag,e,t)+n},e.prototype.componentDidMount=function(){var t=this
this.id&&(this.root=document.getElementById(this.id)),this.root&&this.root.addEventListener("change",function(e){t.props=!!t.root.checked,t.state=t.props?t.value:void 0})},e}(t.WComponent)
t.WCheck=h
...
i&&i.setAttribute("title",this._tooltip)}},enumerable:!1,configurable:!0}),i.prototype.select=function(t){return this.root&&this.options?(this.setState(this.options.length>t?this.options[t]:null),this):this},i.prototype.getProps=function(){if(!this.options||!this.options.length)return null
for(var e=0;e<this.options.length;e++){var i=this.id+"-"+e,n=document.getElementById(i)
if(n&&n.checked){var r=document.getElementById(i+"-l")
if(r)return r.innerText}}return t.WUtil.toString(this.state)},i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),"object"==typeof this.state&&"id"in this.state&&(this.state=this.state.id)},i.prototype.render=function(){var e=""
...
var o=this.options[r],s=this.id+"-"+r
"string"==typeof o?(t.match(this.state,o)?e+='<input type="radio" value="'+o+'" name="'+this.id+'" id="'+s+'" checked'+i+">":e+='<input type="radio" value="'+o+'" name="'+this.id+'" id="'+s+'"'+i+">",e+='<label id="'+s+'-l" for="'+s+'">'+o+"</label>"):(t.match(this.state,o)?e+='<input type="radio" value="'+o.id+'" name="'+this.id+'" id="'+s+'" checked'+i+">":e+='<input type="radio" value="'+o.id+'" name="'+this.id+'" id="'+s+'"'+i+">",e+='<label id="'+s+'-l" for="'+s+'">'+o.text+"</label>"),e+="</div>"}return t.build("div",e,this._style,this._attributes,this.id,this._classStyle)},i.prototype.componentDidMount=function(){var t=this
...
var r=e.options[i]
n.addEventListener("change",function(e){t.setState(r)})}(i)},i.prototype.componentDidUpdate=function(e,i){var n=-1
if(this.state){for(var r=0;r<this.options.length;r++)if(t.match(this.state,this.options[r])){n=r
break}}else n=0
if(n>=0){var o=document.getElementById(this.id+"-"+n)
o&&(o.checked=!0)}},i}(t.WComponent)
t.WRadio=l
...
h+="<td"+t.buildCss(b,p,{w:m})+">"+f+"</td>"}if(this.header&&this.header.length>this.keys.length)for(var v=0;v<this.header.length-this.keys.length;v++)h+="<td"+t.buildCss(this.colStyle)+"></td>"
if(h+="</tr>",this.handlers._rowprepared){var g=document.createElement("template")
g.innerHTML=h
for(var y={element:this.root,rowElement:g.content.firstElementChild,data:a,rowIndex:r},w=0,x=this.handlers._rowprepared;w<x.length;w++){(0,x[w])(y)}h=g.innerHTML}n+=h}e.innerHTML=n}},i.prototype.onSort=function(t){this.handlers._sort||(this.handlers._sort=[]),this.handlers._sort.push(t)},i}(t.WComponent)
t.WTable=d
var c=function(e){function n(i,n,r){var o=e.call(this,i||"*","WFormPanel")||this
return o.rootTag="form",o._attributes=r?'role="form" name="'+o.id+'" action="'+r+'"':'role="form" name="'+o.id+'" action="javascript:void(0);"',o.title=n,t.CSS.FORM&&(t.CSS.FORM.indexOf(":")>0?o.style=t.CSS.FORM:o.classStyle=t.CSS.FORM),o.init(),o}return __extends(n,e),n.prototype.init=function(){return this.rows=[],this.roww=[],this.currRow=null,this.footer=[],this.captions=[],this.addRow(),this},n.prototype.focus=function(){if(!this.mounted)return this
var t=this.first(!0)
...
return a.enabled=!o,this.currRow.push({id:s,label:i,component:a,readonly:o,type:"select"}),this},n.prototype.addBooleanField=function(e,i,n,r){var o=this.subId(e),s=new h(o,"")
return s.divClass=t.CSS.FORM_CHECK,s.divStyle=t.CSS.CHECK_STYLE,s.classStyle=t.CSS.FORM_CTRL,s.label=n,s.tooltip=r,this.currRow.push({id:o,label:i,component:s,type:"boolean"}),this},n.prototype.addBlankField=function(t,e,n){var r=new i("",e,n)
return this.currRow.push({id:"",label:t,component:r,classStyle:e,style:n,type:"blank"}),this},n.prototype.addInternalField=function(t,e){return void 0===e&&(e=null),this.currRow.push({id:this.subId(t),value:e,type:"internal"}),this},n.prototype.addCaption=function(t,e,i,n){if(!t)return this
var o=new r("",t,e,i,n)
return this.currRow.push({id:"",label:"",component:o,readonly:!0,type:"caption"}),this.captions.push(o),this},n.prototype.addComponent=function(t,e,i){return i?(t?(i.id=this.subId(t),this.currRow.push({id:this.subId(t),label:e,component:i,type:"component"})):(i.id="",this.currRow.push({id:"",label:e,component:i,type:"component"})),this):this},n.prototype.addToFooter=function(t){return t||this.footer?(this.footer.push(t),this):this},n.prototype.componentDidMount=function(){this.main=new i(this.id+"-c")
...
if(h.component){var u=Math.floor(12/s)
if(u<1&&(u=1),1==u&&s<11&&(0==a||a==s-1)&&(u=2),h.span&&h.span>0&&(u*=h.span),this.main.addCol(""+u),"caption"!=h.type&&h.component.setState(h.value),h.label&&!h.labelComp){var d=new r(h.id+"-l",h.label,"",h.classStyle)
h.labelComp=d.for(h.id)}l?this.main.addGroup({classStyle:t.CSS.FORM_GROUP},h.labelComp,h.component):(this.main.add(h.labelComp),this.main.add(h.component))}}}if(this.footer&&this.footer.length){this.foot=new i(this.subId("__foot"),this.footerClass,this.footerStyle)
for(var c=0,f=this.footer;c<f.length;c++){var h=f[c]
this.foot.addRow().addCol("12").add(h,"push")}this.main.addRow().addCol("12").add(this.foot)}this.main.mount(this.root)},n.prototype.componentWillUnmount=function(){this.main||this.main.unmount()},n.prototype.clear=function(){for(var t=0;t<this.rows.length;t++)for(var e=this.rows[t],i=0;i<e.length;i++){var n=e[i]
"caption"!=n.type&&(n.component&&n.component.setState(null),n.value=null)}return this},n.prototype.setValue=function(e,i,n){void 0===n&&(n=!0)
...
for(var v=1;v<e.length;v++){var y=this.offx+v*p
r.moveTo(y,this.offy),r.lineTo(y,n.height-s)}r.moveTo(this.offx,this.offy),r.lineTo(n.width-a,this.offy)
...
r.fillText(""+_,0,n.height-s-_*m)}if(r.fillText(""+g,0,this.offy),h)for(var v=0;v<o.length;v++){var y=this.offx+v*p
r.save(),r.translate(y-this.fontSize,n.height),r.rotate(-Math.PI/3),r.fillStyle=this.axis,r.fillText(o[v],0,0),r.restore()}var O=this.props
...
for(var v=1;v<e.length;v++){var y=this.offx+v*p,I=n.height-s-M[v]*m
r.lineTo(y,I)}r.stroke()}}else{this.barw<4&&(this.barw=4)
for(var D=0;D<t.length;D++){var M=t[D]
if(!M||M.length<e.length)return
var W=this.line
i&&i.length>D&&((W=i[D])||(W=this.line)),r.fillStyle=W
for(var T=D*(this.barw+1),v=0;v<e.length;v++){var y=this.offx+v*p,I=n.height-s-M[v]*m
0==v?r.fillRect(y+T,I,this.barw,M[v]*m):t.length<3?r.fillRect(y+T-this.barw/2,I,this.barw,M[v]*m):r.fillRect(y+T-this.barw/2-(this.barw+1)*(t.length-2),I,this.barw,M[v]*m)}}}}}}}},e}(t.WComponent)
t.WChart=o}(WUX||(WUX={}))
var APP
