...
!function(t){function e(t){if(t)return t instanceof Element?t.id:t instanceof T?t.id:"string"==typeof t&&t.indexOf("<")<0?0==t.indexOf("#")?t.substring(1):t:"object"!=typeof t||t.id?"":""+t.id}function i(t,i){var n=e(t)
if(!n)return""
var r=n.indexOf("-")
...
return!n||n.length<2?[e,t.trim(),i]:(e+=n[0],2==n.length?[e,n[1],""]:(i+=n[2],[e,n[1],i]))}function g(t){if(t instanceof T){var e=t.name,i=t.id
...
return o=o?" "+o:"",e.indexOf(".")>0?i+'<img src="'+e+'"'+h+a+">"+n:!r||r<2?i+'<i class="fa '+e+o+'"'+h+a+"></i>"+n:(r>5&&(r=5),i+'<i class="fa '+e+" fa-"+r+"x"+o+'"'+h+a+"></i>"+n)}function R(e,i,n,r,o,s){e||(e="div")
var a,h
...
o.push(e.toNumber(h))}return o},e.toObject=function(t,e){return t instanceof T&&(t=t.getState()),null==t?e:"object"==typeof t?t:e},e.toString=function(i,n){return void 0===n&&(n=""),i instanceof T&&(i=i.getState()),null==i?n:"string"==typeof i?i:i instanceof Date?t.formatDate(i):"object"==typeof i&&void 0!=i.id?e.toString(i.id,n):Array.isArray(i)&&i.length?e.toString(i[0],n):""+i},e.toText=function(t,i){return void 0===i&&(i=""),e.toString(t,i).replace("<","&lt;").replace(">","&gt;")},e.toNumber=function(t,i){if(void 0===i&&(i=0),t instanceof T&&(t=t.getState()),null==t)return i
...
return isNaN(r)?i:r},e.toInt=function(t,i){if(void 0===i&&(i=0),t instanceof T&&(t=t.getState()),null==t)return i
...
return isNaN(r)?i:r},e.toIntTime=function(t,i){if(void 0===i&&(i=0),t instanceof T&&(t=t.getState()),null==t)return i
...
if(this.div&&(r+='<div id="'+this.id+'-c" class="'+this.div+'">'),r+='<table id="'+this.id+'" class="'+i+'"'+n+">",this.header&&this.header.length){var o=!1
...
this.soId.push(f),r+="<th"+t.buildCss(u,c)+'><a style="cursor:pointer;text-decoration:none !important;" id="'+f+'">'+l+' &nbsp;<i class="fa fa-unsorted"></i></a></th>'}else r+="<th"+t.buildCss(u,c)+">"+l+"</th>"}r+="</tr></thead>"}}return r+='<tbody id="'+this.id+'-b"></tbody>',r+="</table>",this.div&&(r+="</div>"),r},i.prototype.componentDidMount=function(){var e=this
...
o&&(o.addEventListener("click",function(i){if(e.selectionMode&&"none"!=e.selectionMode&&e.handlers._selectionchanged){var n=i.target
...
n++
var a=""
a=n==this.state.length-1&&this.footerStyle?"<tr"+t.buildCss(this.footerStyle)+' id="'+this.id+"-"+n+'">':"<tr"+t.buildCss(this.rowStyle)+' id="'+this.id+"-"+n+'">'
...
p.innerHTML=a
for(var y={element:this.root,rowElement:p.content.firstElementChild,data:s,rowIndex:n},v=0,w=this.handlers._rowprepared;v<w.length;v++){(0,w[v])(y)}a=p.innerHTML}i+=a}e.innerHTML=i}},i.prototype.onSort=function(t){this.handlers._sort||(this.handlers._sort=[]),this.handlers._sort.push(t)},i}(t.WComponent)
t.WTable=d
...
return a.enabled=!o,this.currRow.push({id:s,label:i,component:a,readonly:o,type:"select"}),this},n.prototype.addRadioField=function(e,i,n,r,o){var s=this.subId(e),a=new l(s,n,t.CSS.FORM_CTRL,"padding-top:1.5rem;",r)
return a.enabled=!o,this.currRow.push({id:s,label:i,component:a,readonly:o,type:"select"}),this},n.prototype.addBooleanField=function(e,i){var n=this.subId(e),r=new h(n,"")
return r.classStyle=t.CSS.FORM_CTRL,this.currRow.push({id:n,label:i,component:r,type:"boolean"}),this},n.prototype.addBlankField=function(t,e,n){var r=new i("",e,n)
