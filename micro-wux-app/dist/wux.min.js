...
return!n||n.length<2?[e,t.trim(),r]:(e+=n[0],2==n.length?[e,n[1],""]:(r+=n[2],[e,n[1],r]))}function c(t){if(t instanceof A){var e=t.name,r=t.id
...
a!=e?i+=a+" ":n=!0}return n?i.trim():i.trim()+" "+e}function O(t,e){t&&t.setAttribute("class",S(t.getAttribute("class"),e))}function D(t,e){t&&t.setAttribute("class",w(t.getAttribute("class"),e))}function M(t,e){t&&t.setAttribute("class",_(t.getAttribute("class"),e))}function C(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r]
...
i&&O(t,i),n&&t.setAttribute("style",g(n))}return t}function W(t,e,r,n,i,o){if(!t)return""
e||(e=""),r||(r="")
var s=o?' title="'+o+'"':""
...
t.WComponent=A,t.getId=e,t.firstSub=r,t.lastSub=n,t.getComponent=i,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=u,t.getState=l,t.newInstance=h,t.same=p,t.divide=f,t.str=c,t.getTagName=d,t.style=g,t.addStyle=m,t.css=y,t.cls=b,t.attributes=v,t.buildCss=x,t.addClass=S,t.removeClass=w,t.toggleClass=_,t.addClassOf=O,t.removeClassOf=D,t.toggleClassOf=M,t.setCss=C,t.buildIcon=W,t.build=T
...
r||(r=new Date)
var n=""+r.getFullYear(),i=r.getMonth()+1,o=i<10?"0"+i:""+i,s=r.getDate(),a=s<10?"0"+s:""+s,u=r.getHours(),l=u<10?"0"+u:""+u,h=r.getMinutes(),p=h<10?"0"+h:""+h,f=r.getSeconds()
return n+o+a+l+p+(f<10?"0"+f:""+f)},e.nvl=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
case 12:return e?"Dicembre"+r:"Dic"+r}return""}var f={},c={}
t.global={locale:"it",init:function(e){t.debug&&console.log("[WUX] global.init..."),t.debug&&console.log("[WUX] global.init completed"),e&&e()},setData:function(t,e,r){if(void 0===r&&(r=!1),t||(t="global"),f[t]=e,!r&&c[t])for(var n=0,i=c[t];n<i.length;n++){var o=i[n]
o(e)}},getData:function(t,e){t||(t="global")
var r=f[t]
return null==r?e:r},onDataChanged:function(t,e){t||(t="global"),c[t]||(c[t]=[]),c[t].push(e)}}
...
if(this.sortable&&this.sortable.indexOf(s)>=0){var c=this.subId("sort-"+s)
this.soId.push(c),i+="<th"+t.buildCss(h,f)+'><a style="cursor:pointer;text-decoration:none !important;" id="'+c+'">'+l+' &nbsp;<i class="fa fa-unsorted"></i></a></th>'}else i+="<th"+t.buildCss(h,f)+">"+l+"</th>"}i+="</tr></thead>"}}return i+='<tbody id="'+this.id+'-b"></tbody>',i+="</table>",this.div&&(i+="</div>"),i}},r.prototype.componentDidMount=function(){var e=this
...
for(var u=-1,l=0,h=this.keys;l<h.length;l++){var p=h[l],f=s[p],c=""
null==f&&(f=""),u++
...
if(p<1&&(p=1),1==p&&s<11&&(0==u||u==s-1)&&(p=2),l.span&&l.span>0&&(p*=l.span),this.main.addCol(""+p),l.component.setState(l.value),l.component instanceof a){if(!this.checkboxStyle){var f=getComputedStyle(this.context).getPropertyValue("font-size"),c=Math.round(.8*parseInt(f));(isNaN(c)||c<18)&&(c=18),this.checkboxStyle="height:"+c+"px;"}l.component.style=this.checkboxStyle}if(l.label&&!l.labelComp){var d=new n(l.id+"-l",l.label,"",l.classStyle)
